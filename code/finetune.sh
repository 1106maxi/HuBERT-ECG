...
python finetune.py 3 /content/HuBERT-ECG/reproducibility/ptbxl/ptbxl_all_train.csv content/HuBERT-ECG/reproducibility/ptbxl/ptb_all_val.csv 71 8 64 auroc \
    --load_path=/content/HuBERT-ECG/hubert_ecg_small.pt \
